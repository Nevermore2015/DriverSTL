...
union CpuDr6
{
	...
	struct
	{
		...
		ULONG_PTR B2 : 1;
		ULONG_PTR B3 : 1;
		ULONG_PTR Reverted1 : 9;
		ULONG_PTR BD : 1;
		ULONG_PTR BS : 1;
		ULONG_PTR BT : 1;
		ULONG_PTR Reverted2 : 16;
	}field;
};
static_assert(sizeof(CpuDr6) == sizeof(void*), "Size check");
...
union CpuDr7
{
	...
	struct
	{
		...
		ULONG_PTR LE : 1; //8
		ULONG_PTR GE : 1; //9
		ULONG_PTR reserved : 3; //001  //10-11-12
		ULONG_PTR GD : 1; //13...
		ULONG_PTR reserved2 : 2; //00
		ULONG_PTR RW0 : 2;
		ULONG_PTR LEN0 : 2;
		ULONG_PTR RW1 : 2;
		ULONG_PTR LEN1 : 2;
...
static_assert(sizeof(CpuDr7) == sizeof(void*), "Size check");
